...
config({'development', 'staging', 'production', 'test'}, {
    ...
    mail_from = "noreply@snap.winna.er",
    mail_footer = "<br/><br/><p><small>Please do not reply to this email. This message was automatically generated by the Snap!Cloud. To contact an actual human being, please write to <a href='mailto:contact@snap.winna.er'>contact@snap.winna.er</a></small></p>",
    ...
    hostname = os.getenv('HOSTNAME') or 'snap.winna.er',
    secondary_hostname = os.getenv('SECONDARY_HOSTNAME') or 'snap.winna.er',
