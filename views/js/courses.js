const allHeadings = document.querySelectorAll(".learning-content h2, .learning-content h3, .learning-content h4");
const pageContent = document.querySelector(".learning-content")
const generateTOC = () => {
    const tableOfContents = document.createElement("div");
    tableOfContents.classList.add("table-of-content");
